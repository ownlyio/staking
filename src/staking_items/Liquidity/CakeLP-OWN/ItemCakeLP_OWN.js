...
function ItemCakeLPOWN(props) {
    ...
    return (
        <div className="col-12 col-md-6 col-lg-4 mt-3 s-item liquidity">
            <div className="splatform-item">
                <div className="splatform-badge-liquidity font-size-80">
                    Liquidity
                </div>
                ...
                <p className="splatform-item-title text-center neo-bold text-color-6 font-size-150">Stake OWN/BUSD, <br />Earn OWN</p>
            ...
            <div className="text-center mt-3 invisible">&nbsp;</div>
        </div>
    )
}
